...
describe('user selectors', () => {
  ...
  describe('getUserPendingAcks', () => {
    it('should a List of pending acks combined with recipient details', () => {
      const selector = selectors.getUserPendingAcks();
      const expected = fromJS([
        { ...spa.recipients.byId.abc, ...spa.acknowledgments.byId.g },
      ]);
  ...
  describe('getUserPreviousAcks', () => {
    it('should a List of previous acks combined with recipient details', () => {
      const selector = selectors.getUserPreviousAcks();
      const expected = fromJS([
        { ...spa.recipients.byId.def, ...spa.acknowledgments.byId.x },
      ]);
      expect(selector(state)).toEqual(expected);
    });
  });
