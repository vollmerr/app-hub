...
export default [
  {
    ...
    desc: (
      <div>
        <p>Authorizations for current employees can be viewed and edited on the <HelpLink to={'/paas/current'}>Current Staff Authorizations</HelpLink> page. Only managers have access to this page. Authorizations marked yellow indicate that the employee has neither been approved nor denied authorization and action is required. When authorizing employees marked yellow, all applications must be approved or denied before submitting.</p>
        ...
        <p>Authorizations for previous employees can be viewed on the <HelpLink to={'/paas/previous'}>Previous Staff Authorizations</HelpLink> page. These authorizations are for historical purposes only, and cannot be edited.</p>
      </div>
    ),
  },
  {
    ...
    desc: (
      <div>
        <p>Reports for current and previous staff authorizations can be viewed on the <HelpLink to={'/paas/report'}>Reports</HelpLink> page.</p>
        <ul>
  ...
  },
  {
    ...
    desc: (
      <div>
        <p>Employees without managers can be temporarily assigned one using the <HelpLink to={'/paas/admin'}>Admin</HelpLink> page. Only members of the <b>{C.ROLES.SECURITY}</b> AD group have access to this page.</p>
